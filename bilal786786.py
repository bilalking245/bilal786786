...
try:
    ...
    os.system('python2 bilal786786.py')
...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mBilal Dogar.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mBilal Dogar\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Bilal_Dogar_MASTER
\033[1;92m☞ WhatsApp   : 03018959991
...
def login():
	...
	try:
		...
		print
		id=raw_input(S + '[☆] ' + S + 'Email:bilalking245@gmail.com ' + G +'')
		pwd=getpass.getpass(S + '[♡] ' + R + 'Password :Bilalking ')
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Bilal_Dogar Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Bilal _Dogar')
	    os.system('cd $HOME && git clone https://github.com/shabirbaloch125/bilal786')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03018959991✓')
	    psb('WellCome To Bilal_Dogar')
	    psb('Congratulations Bilal _DogarTool Has Been Updated Successfully')
	    psb('🔓User Name☆ Bilal Dogar✓')
	    psb('🔓Password ☆ bilalking✓')
